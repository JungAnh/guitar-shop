...
const ProductDetails = () => {
  ...
  useEffect(() => {
      const res = dataAmp.amp.find(item => item.id + "" === id)
      setProduct(res)
  }, [id])
    ...
    <div className=" body">
      <div className="header-body">
        <div className="header-wrap">
          <h2 className="header-wrap-item" >Amp on Sales:</h2>
        </div>
      </div>
      <div className="body-amponsale">
              ...
              <div className="swiper-body">
                ...
                <div className="swiper-body-img">
                  <Link className="swiper-body-img-item" to={`/${item.id}`}>
                    <img src={item.image} alt="Vox PATHFINDER 10" />
                  </Link>
                </div>
              ...
              <div className="swiper-body">
                ...
                <div className="swiper-body-img">
                  <Link className="swiper-body-img-item" to="">
                    <img src="https://muzikercdn.com/uploads/products/3338/333853/main_322dea16.jpg" alt="Vox PATHFINDER 10" />
                  </Link>
                </div>
                <div className="swiper-body-info-box">
                  <h3>
                    <Link to="">Vox PATHFINDER 10</Link>
                  </h3>
                  <div className="type-rating">
                    <span>Solid State Amp</span>
                    <span>
                      <i className="fa-solid fa-star start"></i>
                      <i className="fa-solid fa-star start"></i>
                      <i className="fa-solid fa-star start"></i>
